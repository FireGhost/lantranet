...
CREATE TABLE "new_AnimationsPlayers" (
...
INSERT INTO "new_AnimationsPlayers" ("animationId", "playerId") SELECT "animationId", "playerId" FROM "AnimationsPlayers";
DROP TABLE "AnimationsPlayers";
ALTER TABLE "new_AnimationsPlayers" RENAME TO "AnimationsPlayers";
