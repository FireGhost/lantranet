...
<template>
  <UForm @submit="saveAppLocale">
    <UFieldGroup>
      <USelect v-model="selectedLocale as Locale" :items="localeSelectItems" class="w-40" />
  ...
  <UForm class="mt-4" @submit="saveCurrencySuffix">
    <UFieldGroup>
      <UInput v-model="currencySuffix" :placeholder="$t('Currency suffix')" class="w-40" />
      <UButton type="submit" icon="i-lucide-save" />
    </UFieldGroup>
  </UForm>
  ...
  <UForm class="mt-4" @submit="saveDatetimeLocale">
    <UFieldGroup>
      <UInput v-model="datetimeLocale" :placeholder="$t('Datetime locale')" class="w-40" />
      <UButton type="submit" icon="i-lucide-save" />
    </UFieldGroup>
  </UForm>
</template>
